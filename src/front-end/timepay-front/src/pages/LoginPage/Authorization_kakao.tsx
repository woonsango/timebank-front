...
const REDIRECT_URI = 'http://13.125.119.30:8080/oauth/redirect/kakao'; //카카오-타임페이 커뮤니티 Redirect URI, 로컬 IP 주소 넣기
//http://13.125.119.30/oauth/redirect/kakao
//http://localhost:3000/oauth/redirect/kakao
